...
docker run --name soap-ui-mock -p 8080:9090 -v /webapps/redbee/soap-ui-mock/project.xml:/project.xml -v /webapps/redbee/soap-ui-mock/entrypoint.sh:/entrypoint.sh --entrypoint=/entrypoint.sh -d saascolon/soap-ui-mock
